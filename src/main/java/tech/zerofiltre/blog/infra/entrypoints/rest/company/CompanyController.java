...
public class CompanyController {
    ...
    public CompanyController(UserProvider userProvider, SecurityContextManager securityContextManager, CompanyProvider companyProvider, CompanyUserProvider companyUserProvider, CompanyCourseProvider companyCourseProvider, MessageSource sources) {
        ...
        this.companyService = new CompanyService(companyProvider, companyUserProvider, companyCourseProvider, isAdminUser, isCompanyExists, isAdminOrCompanyAdmin);
