...
public interface UserJPARepository extends JpaRepository<UserJPA, Long> {
    ...
    @Query("select new tech.zerofiltre.blog.infra.providers.database.user.model.UserEmailLanguage(u.email, u.paymentEmail, u.language) from UserJPA u where u.isSubscribedToNewsLetter = true")
    List<UserEmailLanguage> findAllEmailsForNewsletter();
