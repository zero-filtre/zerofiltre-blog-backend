...
public class MonthlyNewsletterReminder {
    ...
    public void sendNewsletter() {
        ...
        templateModel.put("newArticles", findNewArticles());
        templateModel.put("newCourses", findNewCourses());
        Context thymeleafContext = new Context();
        thymeleafContext.setVariables(templateModel);

        List<UserEmailLanguage> listAllEmails = userProvider.allEmailsForNewsletter();
