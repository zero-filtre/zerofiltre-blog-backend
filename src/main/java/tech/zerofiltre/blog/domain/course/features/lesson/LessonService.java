...
public class LessonService {
    ...
    public Lesson get(long id, long currentUserId) throws ResourceNotFoundException, ForbiddenActionException {
        ...
        if (!lesson.get().isFree()) lesson.get().setNotEnrolledAccess(true);
    ...
    private void updateExistingLesson(Lesson existingLesson, Lesson lesson) {
        ...
        existingLesson.setNumber(lesson.getNumber());
        existingLesson.setResources(lesson.getResources());
        existingLesson.setNotEnrolledAccess(lesson.isNotEnrolledAccess());
    }
}
