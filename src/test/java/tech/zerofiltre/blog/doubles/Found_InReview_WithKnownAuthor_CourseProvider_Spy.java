...
public class Found_InReview_WithKnownAuthor_CourseProvider_Spy implements CourseProvider {
    ...
    public Optional<Course> courseOfId(long id) {
        ...
        return Optional.of(ZerofiltreUtils.createMockCourse(true,Status.IN_REVIEW,new Found_InReview_WithKnownAuthor_CourseProvider_Spy(), author, Collections.emptyList()));
    }
