...
public class Found_Draft_WithUnknownAuthor_CourseProviderSpy implements CourseProvider {
    ...
    public Optional<Course> courseOfId(long id) {
        ...
        return Optional.of(ZerofiltreUtils.createMockCourse(true,Status.DRAFT,new Found_Draft_WithUnknownAuthor_CourseProviderSpy(), author, Collections.emptyList()));
    }
