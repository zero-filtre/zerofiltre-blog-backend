...
public class Found_InReview_WithUnknownAuthor_CourseProviderSpy implements CourseProvider {
    ...
    public Optional<Course> courseOfId(long id) {
        ...
        return Optional.of(ZerofiltreUtils.createMockCourse(true,Status.IN_REVIEW, new Found_InReview_WithUnknownAuthor_CourseProviderSpy(), author, Collections.emptyList()));
    }
