...
public class Found_Published_WithUnknownAuthor_CourseProviderSpy implements CourseProvider {
    ...
    public Optional<Course> courseOfId(long id) {
        ...
        return Optional.of(ZerofiltreUtils.createMockCourse(true,Status.PUBLISHED, new Found_Published_WithUnknownAuthor_CourseProviderSpy(), author, Collections.emptyList()));
    }
