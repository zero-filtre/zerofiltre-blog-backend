...
import tech.zerofiltre.blog.infra.providers.database.company.*;
...
@Import({Jackson2ObjectMapperBuilder.class, DBUserDetailsService.class, JwtAuthenticationTokenProperties.class,
        ...
        APIClientConfiguration.class, GithubAuthenticationTokenProperties.class, Slf4jLoggerProvider.class, DBChapterProvider.class, DBCompanyProvider.class, DBCompanyUserProvider.class, CompanyCourseService.class})
class CourseControllerIT {
    ...
    void onCourseInit_whenValidInput_thenReturn200() throws Exception {
        ...
        RequestBuilder request = MockMvcRequestBuilders.post("/course")
                .param("title", TITLE)
                .param("companyId", String.valueOf(0));
