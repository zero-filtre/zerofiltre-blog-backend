...
class DBLinkCompanyCourseProviderIT {
    ...
    void link() {
        ...
        //WHEN
        LinkCompanyCourse response = dbCompanyCourseProvider.link(linkCompanyCourse);
    ...
    void linkOfByCompanyIdAndCourseId() {
        //GIVEN
        Company company = dbCompanyProvider.save(new Company(0, "Company1", "000000001"));
        User user = dbUserProvider.save(ZerofiltreUtils.createMockUser(false));
        Course course = dbCourseProvider.save(ZerofiltreUtils.createMockCourse(false, Status.PUBLISHED, user, Collections.emptyList(), Collections.emptyList()));
        LinkCompanyCourse linkCompanyCourse = dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course.getId(), false, LocalDateTime.now().minusDays(2), LocalDateTime.now()));

        assertThat(linkCompanyCourse).isNotNull();

        //WHEN
        Optional<LinkCompanyCourse> response = dbCompanyCourseProvider.linkOf(company.getId(), course.getId());
    ...
    void linkOfByCompanyIdAndCourseIdAndActiveIsTrue() {
        //GIVEN
        Company company = dbCompanyProvider.save(new Company(0, "Company1", "000000001"));
        User user = dbUserProvider.save(ZerofiltreUtils.createMockUser(false));
        Course course = dbCourseProvider.save(ZerofiltreUtils.createMockCourse(false, Status.PUBLISHED, user, Collections.emptyList(), Collections.emptyList()));
        LinkCompanyCourse linkCompanyCourse = dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course.getId(), true, LocalDateTime.now(), null));

        assertThat(linkCompanyCourse).isNotNull();

        //WHEN
        Optional<LinkCompanyCourse> response = dbCompanyCourseProvider.linkOf(company.getId(), course.getId(), true);
    ...
    void findAllByCompanyId_returnAllCompanyCourseByCompanyId() {
        ...
        LinkCompanyCourse linkCompanyCourse1 = dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course1.getId(), false, LocalDateTime.now(), null));
        ...
        LinkCompanyCourse linkCompanyCourse2 = dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course2.getId(), false, LocalDateTime.now(), null));
    ...
    void findAllByCompanyId() {
        ...
        dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course1.getId(), true, LocalDateTime.now(), null));

        Course course2 = dbCourseProvider.save(ZerofiltreUtils.createMockCourse(false, Status.PUBLISHED, user, Collections.emptyList(), Collections.emptyList()));

        dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course2.getId(), true, LocalDateTime.now(), null));
    ...
    void unlink() {
        ...
        LinkCompanyCourse linkCompanyCourse = dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company.getId(), course1.getId(), true, LocalDateTime.now(), null));

        Optional<LinkCompanyCourse> cc = dbCompanyCourseProvider.linkOf(linkCompanyCourse.getCompanyId(), linkCompanyCourse.getCourseId(), true);
        assertThat(cc).isPresent();

        //WHEN
        dbCompanyCourseProvider.unlink(linkCompanyCourse);

        //THEN
        cc = dbCompanyCourseProvider.linkOf(linkCompanyCourse.getCompanyId(), linkCompanyCourse.getCourseId(), true);
    ...
    void unlinkAllByCompanyId() {
        ...
        //WHEN
        dbCompanyCourseProvider.unlinkAllByCompanyId(company.getId());
    ...
    void unlinkAllByCourseId() {
        //GIVEN
        Company company1 = dbCompanyProvider.save(new Company(0, "Company1", "000000001"));
        User user = dbUserProvider.save(ZerofiltreUtils.createMockUser(false));
        Course course1 = dbCourseProvider.save(ZerofiltreUtils.createMockCourse(false, Status.PUBLISHED, user, Collections.emptyList(), Collections.emptyList()));

        dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company1.getId(), course1.getId(), false, LocalDateTime.now().minusDays(2), LocalDateTime.now()));

        Company company2 = dbCompanyProvider.save(new Company(0, "Company2", "000000002"));

        dbCompanyCourseProvider.link(new LinkCompanyCourse(0, company2.getId(), course1.getId(), true, LocalDateTime.now(), null));

        //WHEN
        dbCompanyCourseProvider.unlinkAllByCourseId(course1.getId());
