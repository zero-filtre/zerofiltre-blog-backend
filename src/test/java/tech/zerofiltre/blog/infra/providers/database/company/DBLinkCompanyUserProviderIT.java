...
class DBLinkCompanyUserProviderIT {
    ...
    void link() {
        ...
        //WHEN
        LinkCompanyUser response = dbCompanyUserProvider.link(linkCompanyUser);
    ...
    void findByCompanyIdAndUserIdByCompanyIdAndUserId() {
        ...
        dbCompanyUserProvider.link(new LinkCompanyUser(company.getId(), user.getId(), LinkCompanyUser.Role.ADMIN));
    ...
    void findAllByCompanyId() {
        ...
        linkCompanyUser1 = dbCompanyUserProvider.link(linkCompanyUser1);
        ...
        linkCompanyUser2 = dbCompanyUserProvider.link(linkCompanyUser2);
    ...
    void unlink() {
        ...
        linkCompanyUser = dbCompanyUserProvider.link(linkCompanyUser);

        //WHEN
        dbCompanyUserProvider.unlink(linkCompanyUser);
    ...
    void unlinkAllByCompanyId() {
        ...
        dbCompanyUserProvider.link(linkCompanyUser);
        ...
        //WHEN
        dbCompanyUserProvider.unlinkAllByCompanyId(company.getId());
    ...
    void unlinkAllByCompanyIdExceptAdminRole() {
        //GIVEN
        Company company = new Company(0, "Company1", "000000001");
        company = dbCompanyProvider.save(company);
        ...
        //WHEN
        dbCompanyUserProvider.unlinkAllByCompanyIdExceptAdminRole(company.getId());
    ...
    void unlinkAllByUserId() {
        ...
        //WHEN
        dbCompanyUserProvider.unlinkAllByUserId(user.getId());
