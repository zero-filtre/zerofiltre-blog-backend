...
class ResetPasswordListenerTest {
    ...
    @BeforeEach
    void setUp() {
        resetPasswordListener = new ResetPasswordListener(messageSource, mailSender, tokenManager);
    }
    ...
    void onResetPassword_CreateToken_ThenNotify() {
        ...
        OnResetPasswordEvent event = new OnResetPasswordEvent(
                user,
                Locale.FRANCE,
                "appUrl"
        );
        ...
        //ACT
        resetPasswordListener.onApplicationEvent(event);
