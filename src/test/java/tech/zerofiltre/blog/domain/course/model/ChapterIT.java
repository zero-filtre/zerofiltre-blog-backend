...
class ChapterIT {
    ...
    void moveLessonAtTheSamePositionIsOk() throws ForbiddenActionException, ResourceNotFoundException {
        ...
        //when
        chapter = chapter.moveLesson(author.getId(), lesson1.getId(), 1);
    ...
    void moveChapterAtTheSamePositionIsOk() throws BlogException {
        ...
        chapters.forEach(aChapter -> {
            if (aChapter.getId() == chapter1.getId()) assertThat(aChapter.getNumber()).isEqualTo(1);
            if (aChapter.getId() == chapter.getId()) assertThat(aChapter.getNumber()).isEqualTo(2);
            if (aChapter.getId() == chapter3.getId()) assertThat(aChapter.getNumber()).isEqualTo(3);
        });

        //when
        chapter = chapter.move(author.getId(), 2);

        //then
        List<Chapter> reOrderedChapters = chapter.getByCourseId(author);
        assertThat(reOrderedChapters.size()).isEqualTo(3);

        // Check that the moved lesson is still in position 2
    ...
    void moveChapterUpIsOk() throws BlogException {
        ...
        //when
        chapter = chapter.move(author.getId(), 1);
        ...
        reOrderedChapters.forEach(aChapter -> {
            if (aChapter.getId() == chapter1.getId()) assertThat(aChapter.getNumber()).isEqualTo(2);
            if (aChapter.getId() == chapter.getId()) assertThat(aChapter.getNumber()).isEqualTo(1);
            if (aChapter.getId() == chapter3.getId()) assertThat(aChapter.getNumber()).isEqualTo(3);
        });
    ...
    void moveChapterDownIsOk() throws BlogException {
        ...
        //when
        chapter = chapter.move(author.getId(), 3);
        ...
        reOrderedChapters.forEach(aChapter -> {
            if (aChapter.getId() == chapter1.getId()) assertThat(aChapter.getNumber()).isEqualTo(1);
            if (aChapter.getId() == chapter.getId()) assertThat(aChapter.getNumber()).isEqualTo(3);
            if (aChapter.getId() == chapter3.getId()) assertThat(aChapter.getNumber()).isEqualTo(2);
        });
