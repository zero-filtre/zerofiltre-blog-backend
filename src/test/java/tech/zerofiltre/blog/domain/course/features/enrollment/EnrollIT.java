...
class EnrollIT {
    ...
    void init() throws ZerofiltreException {
        ...
        enroll = new Enroll(enrollmentProvider, dbCourseProvider, dbUserProvider, chapterProvider, null, dbPurchaseProvider, dbCompanyUserProvider, dbCompanyCourseProvider);
    ...
    void givenCompanyUserAndCompanyCourse_enrollGetsExecutedProperly() throws ZerofiltreException {
        ...
        LinkCompanyUser linkCompanyUser = dbCompanyUserProvider.link(new LinkCompanyUser(company.getId(), user.getId(), LinkCompanyUser.Role.ADMIN));
